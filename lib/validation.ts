...
export const BookSchema = z.object({
  ...
  genre: z.string(),
  list_price_cents: z.number().int().nonnegative(),
  ...
  format: z.enum(['Hardcover', 'Paperback', 'Mass Market', 'Other']).optional(),
  supply_source: z.enum(['local', 'ingram']),
  ingram_stock_level: z.enum(['In Stock', 'Low Stock', 'Out of Stock']).optional(),
  last_stock_sync: z.string().optional(),
